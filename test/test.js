...
const { StartingPage } = require("../pages/startingPage");
const { data } = require("../data/data");
const { businessProfessionPage } = require("../pages/businessProfessionapage");
const { detail } = require("../pages/detail");
const { contact } = require("../pages/contactInfoPage");
const { confirmation } = require("../pages/confirmationPage");
